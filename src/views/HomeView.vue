            ...
            <div class="row card-left">
              ...
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img src="../img/realMadrid.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img src="../img/barça.2.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img src="../img/ajax.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
        ...
        <div class="carousel-item">
          <div class="container">
            <div class="row card-left">
              ...
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img src="../img/brasil.Branca.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img src="../img/Corinthians.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
        ...
        <div class="carousel-item ">
          <div class="container">
            <div class="row card-left">
              ...
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img src="../img/PSG.2020.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
              ...
              <div class="col">
                <div class="card" style="width: 18rem;">
                  <img src="../img/arsenal.jpg" class="card-img-top" alt="...">
                  <div class="card-body">
