          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/Selecoes">Seleções</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col mb-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2"><a href="/masculino" class="nav-link p-0 text-muted">masculino</a></li>
            <li class="nav-item mb-2"><a href="/feminino" class="nav-link p-0 text-muted">Feminino</a></li>
            <li class="nav-item mb-2"><a href="/selecoes" class="nav-link p-0 text-muted">Seleções</a></li>
          </ul>
        </div>
        ...
        <div class="col mb-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2"><a href="https://www.instagram.com/wh_outlet/" target="_blank" rel="noopener noreferrer" class="nav-link p-0 text-muted">
